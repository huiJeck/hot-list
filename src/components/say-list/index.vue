<template>
  <div style="width:100%;">
    <DescriptionList layout="vertical" col="5">
      <Description v-for="(item, index) in newList" :key="index" :term="item.title">
        <Image :src="item.url" fit="contain" preview :preview-list="[item.url]" :initial-index="item.index" />
      </Description>
    </DescriptionList>
